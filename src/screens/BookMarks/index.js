  ...
  const exFlatlist = () => {
    return (
      <View>
        ...
        {Epost.length > 0 && <Text style={Styles.biotxt}>ePoster</Text>}
        <FlatList
          showsVerticalScrollIndicator={false}
          showsHorizontalScrollIndicator={false}
          data={Epost}
          renderItem={renderItemEpost}></FlatList>
        {SessionsM.length > 0 && (
  ...
  return (
    <View style={Styles.mainscrview}>
      ...
      <Header
        ...
        <Text style={Styles.txtbookmark}>BookMarks</Text>
      </Header>
