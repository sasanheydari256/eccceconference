...
const Courses = (props) => {
  ...
  //     request("POST", 'GetCourseSliderAnyEvent', {
  //         EventId: props.route.params.Id,
  //     }, () => { }, () => { },
  //         (e) => {
  //             setModalVisible(false)
      ...
      <TouchableOpacity
        onPress={async () => {
          ...
          if (Token !== null && Token !== undefined && Token !== '') {
            props.navigation.navigate('CDetaile', {Datas: item});
          } else {
            setModalVisible(false);
            Alert.alert(
              'Log In to Register',
        ...
        <Image
          resizeMode={'cover'}
          style={{width: '100%', minHeight: 150, maxHeight: 150}}
          source={{uri: BASE_URL_IMG + item.Image}}
        />
        <View style={{width: '100%'}}>
          {/* <Text style={Styles.Timeing}>{item.Time} hr</Text> */}
          <Text
            style={{
              width: '100%',
              textAlign: 'center',
