        ...
        {props.switchas && (
          ...
          >
            <Image
              ...
              source={
                IMG == null
                  ? require('../../assets/img/Profile(3).png')
                  : {uri: IMG}
              }></Image>
          </TouchableOpacity>
        )}
        <View style={{paddingHorizontal: 20, flexDirection: 'column'}}>
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  ...
                  resizeMode={'contain'}
                  source={require('../../assets/img/Swich.png')}></Image>
              </View>
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/LiverStream.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[0].Name}</Text>
            </TouchableOpacity>
          )}
          {props.InEvent && (
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/chat.png')}></Image>
              </View>
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/Exhbitor.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[1].Name}</Text>
            </TouchableOpacity>
          )}
          {/* {
            props.InEvent &&
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/ActivityFeed.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[2].Name}</Text>
            </TouchableOpacity>
          )}
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/W-M.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[3].Name}</Text>
            </TouchableOpacity>
          )}
          {props.switchas &&
          ...
          {props.InEvent && props.Pages[4]?.Status && (
            <TouchableOpacity
              ...
              <Text style={{marginHorizontal: 15}}>{props.Pages[4].Name}</Text>
            </TouchableOpacity>
          )}
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/Committee.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[5].Name}</Text>
            </TouchableOpacity>
          )}
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/Faculity.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[6].Name}</Text>
            </TouchableOpacity>
          )}
          {props.switchas &&
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/Program.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[7].Name}</Text>
            </TouchableOpacity>
          )}
          {props.switchas &&
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/Workshop.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[8].Name}</Text>
            </TouchableOpacity>
          )}
          {/* {
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/Sponsor.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[9].Name}</Text>
            </TouchableOpacity>
          )}
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/MyPicture.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[10].Name}</Text>
            </TouchableOpacity>
          )}
            ...
            <TouchableOpacity
              ...
              <View style={Styles.iconmenu}>
                <Image
                  style={{width: '100%', height: '100%'}}
                  resizeMode={'contain'}
                  source={require('../../assets/img/Contactus.png')}></Image>
              </View>
              <Text style={{marginHorizontal: 15}}>{props.Pages[11].Name}</Text>
            </TouchableOpacity>
          )}
          {props.InEvent && props.Pages[12]?.Status && (
            <TouchableOpacity
              ...
              <Text style={{marginHorizontal: 15}}>{props.Pages[12].Name}</Text>
            </TouchableOpacity>
          )}
        </View>
        <View
        ...
        <TouchableOpacity
          ...
          <View style={Styles.iconmenu}>
            <Image
              ...
              resizeMode={'contain'}
              source={require('../../assets/img/F2.png')}></Image>
          </View>
